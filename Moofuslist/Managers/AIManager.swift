...
// MARK: - Protocol
protocol AIManaging: Actor {
  var stream: AsyncStream<AIManager.Message> { get }
  func cancelLoading()
  func findActivities(cityState: String) async throws
}
extension AIManager: AIManaging {}

actor AIManager {
  static let maxNumOfActivities = 10

  private var cancelStreamLoop = false
  ...
  """
  private let logger = Logger(subsystem: "com.moofus.moofuslist", category: "AIManager")
